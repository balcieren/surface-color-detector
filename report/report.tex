...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{8cm}|}
        ...
        \hline
        Service UUID & \texttt{4fafc201-1fb5-459e-} \texttt{8fcc-c5c9c331914b} \\
        \hline
        Characteristic UUID & \texttt{beb5483e-36e1-4688-} \texttt{b7f5-ea07361b26a8} \\
        \hline
...
\begin{itemize}
    ...
    \item \textbf{Custom 3D Printed Enclosure:} Design and print a protective plastic enclosure for the PCB and sensor to ensure durability and block ambient light (postponed due to time constraints)
...
\bibitem{tcs3200}
ams AG, "TCS3200 Programmable Color Light-to-Frequency Converter," Datasheet, Available: \url{https://look.ams-osram.com/m/664723bdb31f55db/original/TCS3200-DS000107.pdf}, 2011.
...
\bibitem{amsosram}
ams-osram, ``TCS3200 Color Sensor,'' Product Page/Datasheet, Available: \url{https://look.ams-osram.com/m/664723bdb31f55db/original/TCS3200-DS000107.pdf}, Accessed: Jan. 2026.
...
\begin{itemize}
    \item TCS3200: \url{https://look.ams-osram.com/m/664723bdb31f55db/original/TCS3200-DS000107.pdf}
