...
\titleformat{\chapter}[display]
    ...
    {\chaptertitlename\ \thechapter}{20pt}{\fontsize{18pt}{22pt}\selectfont}
...
% ============================================================================
\captionsetup[figure]{font=small, labelfont=bf, position=below, justification=centering}
\captionsetup[table]{font=small, labelfont=bf, position=above, justification=raggedright, singlelinecheck=false}
...
\begin{titlepage}
    ...
    \begin{minipage}{0.5\textwidth}
        \begin{flushleft}
            \textbf{Group:} % TODO: Add group number \\[0.3cm]
            \textbf{Students:}\\
            % TODO: Add student names, surnames, and album numbers
            % Format: Name Surname (Album Number)
            1. % TODO: Student 1 \\
            2. % TODO: Student 2 \\
            3. % TODO: Student 3 \\
        \end{flushleft}
...
\begin{figure}[H]
    \centering
    % TODO: Add TCS3200 block diagram image
    % \includegraphics[width=0.8\textwidth]{images/tcs3200_block.png}
    \caption{TCS3200 functional block diagram showing the photodiode array and current-to-frequency converter}
...
\begin{figure}[H]
    \centering
    % TODO: Add photo of the actual assembled system
    % \includegraphics[width=0.8\textwidth]{images/system_photo.jpg}
    \caption{Photograph of the assembled Surface Color Detector system}
    \label{fig:system_photo}
\end{figure}

% TODO: Add description of physical components visible in photo

\section{Electrical Schematic}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{circuit_image.png}
    \caption{Complete electrical schematic diagram of the Surface Color Detector}
    \label{fig:schematic}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[process, right of=pressed, xshift=3cm] (sample) {Take sample};
        \node[decision, below of=pressed, yshift=-1cm] (hold2s) {Hold $\geq$ 2s?};
        \node[process, right of=hold2s, xshift=3cm] (finalize) {Finalize \& send};
        \node[decision, below of=hold2s, yshift=-1cm] (hold5s) {Hold $\geq$ 5s?};
        \node[process, right of=hold5s, xshift=3cm] (ledtoggle) {Toggle LED};
...
\begin{figure}[H]
    \centering
    % TODO: Add mobile app screenshot
    % \includegraphics[width=0.4\textwidth]{images/mobile_app.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{freq/black.png}
    \caption{Frequency output for black surface: 1.48 kHz}
    \label{fig:freq_black}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{freq/white.png}
    \caption{Frequency output for white surface: 11.53 kHz}
    \label{fig:freq_white}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{freq/blue.png}
    \caption{Frequency output for blue surface: 3.54 kHz}
    \label{fig:freq_blue}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{freq/green.png}
    \caption{Frequency output for green surface: 4.83 kHz}
    \label{fig:freq_green}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{freq/yellow.png}
    \caption{Frequency output for yellow surface: 13.24 kHz}
    \label{fig:freq_yellow}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{freq/pink.png}
    \caption{Frequency output for pink surface: 10.14 kHz}
    \label{fig:freq_pink}
\end{figure}
...
% TODO: Add color detection test results
% Format: Test color | Detected color | RGB values | Pass/Fail
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|c|c|c|l|}
        ...
        \hline
        % TODO: Fill in actual test results
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        Short press & Take one color sample \\
        Hold 2 seconds & Finalize measurement, send via BLE \\
        Hold 5 seconds & Toggle LED on/off \\
...
\begin{figure}[H]
    \centering
    % TODO: Add measurement procedure diagram or photo
...
\begin{enumerate}
    ...
    % TODO: Add more problems encountered during development
\end{enumerate}
...
\bibitem{ssd1306}
Solomon Systech, "SSD1306 128x64 Dot Matrix OLED/PLED Segment/Common Driver with Controller," Datasheet, 2008.
...
% TODO: Add PCB layout images if available
% If breadboard was used, note: "The prototype was assembled on a breadboard. No custom PCB was designed for this project."

The prototype was assembled on a breadboard for rapid development and testing. Future revisions may include a custom PCB design for improved reliability and reduced form factor.

\chapter{Complete Source Code}

The complete source code is available in the project repository. Key files include:
...
% TODO: Add full code listings if required
% \lstinputlisting[language=C++, caption={main.cpp}]{../mcu/src/main.cpp}
% \lstinputlisting[language=C++, caption={color\_sensor.cpp}]{../mcu/src/color\_sensor.cpp}
