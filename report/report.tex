...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \node[align=center] at (5,2.5) {\textbf{[IMAGE PLACEHOLDER]}\\[0.3cm]System Photograph};
    \end{tikzpicture}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{freq/black.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{freq/white.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{freq/blue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{freq/green.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{freq/yellow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{freq/pink.png}
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw[thick, dashed] (0,0) rectangle (8,4);
        \node[align=center] at (4,2) {\textbf{[IMAGE PLACEHOLDER]}\\[0.3cm]Measurement Positioning};
    \end{tikzpicture}
